...
public class Taxii11Response {
    ...
    private HttpHeaders makeHeaders() {
        ...
        headers.set("published", "true");
        return headers;
    }

    private void sendToMisp(String stixId, String stixPackageXml) throws IOException, InterruptedException {
        ...
        stixPackageXml = TestFile.getValidTestXmlFile();
        ...
        // HttpComponentsClientHttpRequestFactory rtRequestFactory=
        ...
        log.info("Package stixId:" + stixId);
        log.info("MISP Server URL :: " + url);
        // log.info("\n\n\n"+DisplayXmlFile.format(stixPackageXml));
        ...
        try {
            ...
            // log.info("URL::::::::::::::::::::::"+url);
            // log.info(DisplayXmlFile.format(entity.getBody()));
            Thread.sleep(10000);
            ...
            Thread.sleep(10000);
            response = restTemplate.exchange(new URI("https://aaindex.com/events/publish/" + eid), HttpMethod.POST,
                    entity, String.class);
    ...
    private void storeStixPackagesToFile(List<Node> stixPackages) {
        stixPackages.stream().forEach(stixPackage -> {
            ...
            try {
                String temp = TestFile.getValidTestXmlFile();
                // storeToFile(stixId, Taxii11Request.toXml(stixPackage));
                storeToFile(stixId, temp);
            } catch (IOException e) {
                log.error(e.getMessage());
            }
        });
